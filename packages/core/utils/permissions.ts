...
export const routePermissions: Record<string, RoleTypes[]> = {
  ...
  "GET /groups/{groupSlug}/events/notification-status":
  ...
  "POST /events/{eventId}/mark-description-as-seen": RoleGroups.ALL_LOGGED_IN,
  "POST /events/{eventId}/mark-general-as-seen": RoleGroups.ALL_LOGGED_IN,
  ...
  "GET /groups/{groupName}/repertoires/{repertoireId}/materials":
    RoleGroups.ALL_LOGGED_IN,
  "POST /groups/{groupName}/repertoires/{repertoireId}/link-materials":
    RoleGroups.MANAGEMENT,
  "DELETE /groups/{groupName}/repertoires/{repertoireId}/materials/{materialId}":
    RoleGroups.MANAGEMENT,
